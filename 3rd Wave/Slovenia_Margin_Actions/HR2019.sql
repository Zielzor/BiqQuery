CREATE OR REPLACE TABLE  `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja1` AS 
SELECT
a.date_key,
a.globalPc_key,
a.version_key,
...
AND a.date_key BETWEEN 20190101 AND 20191231 
AND a.globalpc_key=b.globalpc_key
AND b.salesOrg_key='5910'
...
CREATE OR REPLACE TABLE  `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja2` AS 
SELECT 
a.*,
...
FROM `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja1`  a,
...
CREATE OR REPLACE TABLE  `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja3` AS 
SELECT DISTINCT
a.*,
b.productDesc as bArticle_Name,

FROM `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja2` a
      LEFT JOIN `conrad-cbdp-prod-core.de_conrad_dwh1000_dwh_DimProductSalesOrg.DimProductSalesOrg` b on a.productNo_key = b.productNo_key and b.salesOrg_key = "5910";

---------etap czwarty dowiązanie DimCustomer
CREATE OR REPLACE TABLE `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja4` AS 
SELECT
a.*,
...
FROM  `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja3` a,
...
CREATE OR REPLACE TABLE `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja5` AS 
SELECT
a.*,
b.insert_key as InsertKey
FROM `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja4` a,
...
CREATE OR REPLACE TABLE `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja6` AS 
SELECT 
a.*,
b.paymentMethodDescEng as PaymentMethod


FROM `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja5` a,
...
CREATE OR REPLACE TABLE `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja7` AS 
SELECT 
a.*,
b.billingKind_key as Document_type,
b.billingKindDescEng as Document_Name,

FROM  `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja6` a,
...
CREATE OR REPLACE TABLE `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja8` AS 
SELECT 
a.*,
b.Grupa_Insert_1

FROM `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja7` as a
...
CREATE OR REPLACE TABLE `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja9` AS 
SELECT 
a.*,
b.KamName
FROM `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja8` as a 
...
CREATE OR REPLACE TABLE `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja10` AS 
SELECT 
a.*,
b.date

FROM `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja9` as a, 
...
CREATE OR REPLACE TABLE `ceeregion-prod.AA_MarginActions_Slovenia.Dashboard_CEPL_2019_HR` AS 
SELECT	
a.date as Data,
a.fiscalYear,	
a.period,
...
FROM `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja10` as a

ORDER BY DATA DESC;

---drop śmietnika
DROP TABLE `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja1`;
DROP TABLE `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja2`;
DROP TABLE `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja3`;
DROP TABLE `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja4`;
DROP TABLE `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja5`;
DROP TABLE `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja6`;
DROP TABLE `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja7`;
DROP TABLE `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja8`;
DROP TABLE `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja9`;
DROP TABLE `ceeregion-prod.AA_MarginActions_Slovenia.chorwacja10`;