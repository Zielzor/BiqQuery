...
WHERE a.partitionDate BETWEEN  "2017-12-29"  and CURRENT_DATE() #wycinek poddawany analizie
...
WHERE partitionDate BETWEEN  "2017-01-01"  and CURRENT_DATE()
...
--- union całości
CREATE OR REPLACE TABLE `ceeregion-prod.AA_Tabela_Testowa.Bury_Fluke` AS
SELECT *
