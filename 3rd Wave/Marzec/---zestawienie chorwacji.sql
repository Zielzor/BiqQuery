CREATE OR REPLACE TABLE  `ceeregion-prod.Dashboards_CEPL_2020.chorwacja1` AS 
SELECT
a.date_key,
a.globalPc_key,
a.version_key,
...
GROUP BY a.dateCreation DESC,a.invoiceNo_key,a.orderNo_key,a.OrderNo,a.orderType_key,a.quantitySales,a.invoiceNo,a.salesOrderPos, 
...
CREATE OR REPLACE TABLE  `ceeregion-prod.Dashboards_CEPL_2020.chorwacja2` AS 
SELECT 
a.*,
...
FROM `ceeregion-prod.Dashboards_CEPL_2020.chorwacja1`  a,
...
CREATE OR REPLACE TABLE  `ceeregion-prod.Dashboards_CEPL_2020.chorwacja3` AS 
SELECT DISTINCT
a.*,
b.productDesc as bArticle_Name,

FROM `ceeregion-prod.Dashboards_CEPL_2020.chorwacja2` a
...
CREATE OR REPLACE TABLE `ceeregion-prod.Dashboards_CEPL_2020.chorwacja4` AS 
SELECT
a.*,
...
FROM  `ceeregion-prod.Dashboards_CEPL_2020.chorwacja3` a,
...
CREATE OR REPLACE TABLE `ceeregion-prod.Dashboards_CEPL_2020.chorwacja5` AS 
SELECT
a.*,
b.insert_key as InsertKey
FROM `ceeregion-prod.Dashboards_CEPL_2020.chorwacja4` a,
...
CREATE OR REPLACE TABLE `ceeregion-prod.Dashboards_CEPL_2020.chorwacja6` AS 
SELECT 
a.*,
b.paymentMethodDescEng as PaymentMethod


FROM `ceeregion-prod.Dashboards_CEPL_2020.chorwacja5` a,
...
CREATE OR REPLACE TABLE `ceeregion-prod.Dashboards_CEPL_2020.chorwacja7` AS 
SELECT 
a.*,
b.billingKind_key as Document_type,
b.billingKindDescEng as Document_Name,

FROM  `ceeregion-prod.Dashboards_CEPL_2020.chorwacja6` a,
...
CREATE OR REPLACE TABLE `ceeregion-prod.Dashboards_CEPL_2020.chorwacja8` AS 
SELECT 
a.*,
b.Grupa_Insert_1

FROM `ceeregion-prod.Dashboards_CEPL_2020.chorwacja7` as a
...
CREATE OR REPLACE TABLE `ceeregion-prod.Dashboards_CEPL_2020.chorwacja9` AS 
SELECT 
a.*,
b.KamName
FROM `ceeregion-prod.Dashboards_CEPL_2020.chorwacja8` as a 
...
CREATE OR REPLACE TABLE `ceeregion-prod.Dashboards_CEPL_2020.chorwacja10` AS 
SELECT 
a.*,
b.date

FROM `ceeregion-prod.Dashboards_CEPL_2020.chorwacja9` as a, 
...
CREATE OR REPLACE TABLE `ceeregion-prod.Dashboards_CEPL_2020.Dashboard_CEPL_2020_HR` AS 
SELECT	
a.date as Data,
a.fiscalYear,	
a.period,
...
FROM `ceeregion-prod.Dashboards_CEPL_2020.chorwacja10` as a

ORDER BY DATA DESC;

---drop śmietnika
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.chorwacja1`;
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.chorwacja2`;
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.chorwacja3`;
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.chorwacja4`;
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.chorwacja5`;
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.chorwacja6`;
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.chorwacja7`;
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.chorwacja8`;
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.chorwacja9`;
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.chorwacja10`;