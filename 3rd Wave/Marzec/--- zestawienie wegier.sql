CREATE OR REPLACE TABLE  `ceeregion-prod.Dashboards_CEPL_2020.wegry1` AS 
SELECT
a.date_key,
a.globalPc_key,
a.version_key,
...
CREATE OR REPLACE TABLE  `ceeregion-prod.Dashboards_CEPL_2020.wegry2` AS 
SELECT 
a.*,
...
FROM `ceeregion-prod.Dashboards_CEPL_2020.wegry1`  a,
...
CREATE OR REPLACE TABLE  `ceeregion-prod.Dashboards_CEPL_2020.wegry3` AS 
SELECT DISTINCT
a.*,
b.productDesc as bArticle_Name,

FROM `ceeregion-prod.Dashboards_CEPL_2020.wegry2` a
      LEFT JOIN `conrad-cbdp-prod-core.de_conrad_dwh1000_dwh_DimProductSalesOrg.DimProductSalesOrg` b on a.productNo_key = b.productNo_key and b.salesOrg_key = "5950";

---------etap czwarty dowiązanie DimCustomer
CREATE OR REPLACE TABLE `ceeregion-prod.Dashboards_CEPL_2020.wegry4` AS 
SELECT
a.*,
...
FROM  `ceeregion-prod.Dashboards_CEPL_2020.wegry3` a,
...
CREATE OR REPLACE TABLE `ceeregion-prod.Dashboards_CEPL_2020.wegry5` AS 
SELECT
a.*,
b.insert_key as InsertKey
FROM `ceeregion-prod.Dashboards_CEPL_2020.wegry4` a,
...
CREATE OR REPLACE TABLE `ceeregion-prod.Dashboards_CEPL_2020.wegry6` AS 
SELECT 
a.*,
b.paymentMethodDescEng as PaymentMethod


FROM `ceeregion-prod.Dashboards_CEPL_2020.wegry5` a,
...
CREATE OR REPLACE TABLE `ceeregion-prod.Dashboards_CEPL_2020.wegry7` AS 
SELECT 
a.*,
b.billingKind_key as Document_type,
b.billingKindDescEng as Document_Name,

FROM  `ceeregion-prod.Dashboards_CEPL_2020.wegry6` a,
...
CREATE OR REPLACE TABLE `ceeregion-prod.Dashboards_CEPL_2020.wegry8` AS 
SELECT 
a.*,
b.Grupa_Insert_1

FROM `ceeregion-prod.Dashboards_CEPL_2020.wegry7` as a
...
CREATE OR REPLACE TABLE `ceeregion-prod.Dashboards_CEPL_2020.wegry9` AS 
SELECT 
a.*,
b.KamName
FROM `ceeregion-prod.Dashboards_CEPL_2020.wegry8` as a 
...
CREATE OR REPLACE TABLE `ceeregion-prod.Dashboards_CEPL_2020.wegry10` AS 
SELECT 
a.*,
b.date

FROM `ceeregion-prod.Dashboards_CEPL_2020.wegry9` as a, 
...
CREATE OR REPLACE TABLE `ceeregion-prod.Dashboards_CEPL_2020.Dashboard_CEPL_2020_HU` AS 
SELECT	
a.date as Data,
a.fiscalYear,	
a.period,
...
FROM `ceeregion-prod.Dashboards_CEPL_2020.wegry10` as a

ORDER BY DATA DESC;

---drop śmietnika
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.wegry1`;
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.wegry2`;
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.wegry3`;
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.wegry4`;
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.wegry5`;
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.wegry6`;
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.wegry7`;
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.wegry8`;
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.wegry9`;
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.wegry10`;