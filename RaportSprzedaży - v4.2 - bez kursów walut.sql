...
a.customerDiscount as  _31_Customer_Discount_EURO(C),
a.priceReduction as _32_Price_Reduction_EURO(A=B+C+D), 
...
`conrad-cbdp-prod-core.de_conrad_dwh1000_dwh_DimVersion.DimVersion` n 
...
and n.budgetType_key  = "IS" 
and m.version_key = n.version_key
