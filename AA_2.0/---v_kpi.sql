...
COUNT(DISTINCT(CASE WHEN Managed_As = "DMC" THEN 1 else null END ))AS Count_DMC_Customers,
COUNT(DISTINCT(CASE WHEN Managed_As = "PMC" THEN 1 else null  END)) AS Count_PMC_Customers,
