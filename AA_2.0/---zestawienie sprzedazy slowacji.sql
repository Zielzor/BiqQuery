CREATE OR REPLACE TABLE  `ceeregion-prod.Dashboards_CEPL_2020.slowacja1` AS 
SELECT
a.date_key,
a.globalPc_key,
a.version_key,
...
CREATE OR REPLACE TABLE  `ceeregion-prod.Dashboards_CEPL_2020.slowacja2` AS 
SELECT 
a.*,
...
FROM `ceeregion-prod.Dashboards_CEPL_2020.slowacja1`  a,
...
CREATE OR REPLACE TABLE  `ceeregion-prod.Dashboards_CEPL_2020.slowacja3` AS 
SELECT DISTINCT
a.*,
b.productDesc as bArticle_Name,

FROM `ceeregion-prod.Dashboards_CEPL_2020.slowacja2` a
...
CREATE OR REPLACE TABLE `ceeregion-prod.Dashboards_CEPL_2020.slowacja4` AS 
SELECT
a.*,
...
FROM  `ceeregion-prod.Dashboards_CEPL_2020.slowacja3` a,
...
CREATE OR REPLACE TABLE `ceeregion-prod.Dashboards_CEPL_2020.slowacja5` AS 
SELECT
a.*,
b.insert_key as InsertKey
FROM `ceeregion-prod.Dashboards_CEPL_2020.slowacja4` a,
...
CREATE OR REPLACE TABLE `ceeregion-prod.Dashboards_CEPL_2020.slowacja6` AS 
SELECT 
a.*,
b.paymentMethodDescEng as PaymentMethod


FROM `ceeregion-prod.Dashboards_CEPL_2020.slowacja5` a,
...
CREATE OR REPLACE TABLE `ceeregion-prod.Dashboards_CEPL_2020.slowacja7` AS 
SELECT 
a.*,
b.billingKind_key as Document_type,
b.billingKindDescEng as Document_Name,

FROM  `ceeregion-prod.Dashboards_CEPL_2020.slowacja6` a,
...
CREATE OR REPLACE TABLE `ceeregion-prod.Dashboards_CEPL_2020.slowacja8` AS 
SELECT 
a.*,
b.Grupa_Insert_1

FROM `ceeregion-prod.Dashboards_CEPL_2020.slowacja7` as a
...
CREATE OR REPLACE TABLE `ceeregion-prod.Dashboards_CEPL_2020.slowacja9` AS 
SELECT 
a.*,
b.KamName
FROM `ceeregion-prod.Dashboards_CEPL_2020.slowacja8` as a 
...
CREATE OR REPLACE TABLE `ceeregion-prod.Dashboards_CEPL_2020.slowacja10` AS 
SELECT 
a.*,
b.date

FROM `ceeregion-prod.Dashboards_CEPL_2020.slowacja9` as a, 
...
CREATE OR REPLACE TABLE `ceeregion-prod.Dashboards_CEPL_2020.Dashboard_CEPL_2020_SK` AS 
SELECT	
a.date as Data,
a.fiscalYear,	
a.period,
...
FROM `ceeregion-prod.Dashboards_CEPL_2020.slowacja10` as a

ORDER BY DATA DESC;

---drop śmietnika
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.slowacja1`;
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.slowacja2`;
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.slowacja3`;
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.slowacja4`;
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.slowacja5`;
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.slowacja6`;
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.slowacja7`;
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.slowacja8`;
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.slowacja9`;
DROP TABLE `ceeregion-prod.Dashboards_CEPL_2020.slowacja10`;
