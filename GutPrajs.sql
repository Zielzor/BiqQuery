...
GROUP BY productNo,productDesc,matClass_key,a.salesPrice,b.purPriceAverage,a.purPriceAverage,k.rate,a.priceUnit ,b.statusCrossSite,b.statusCrossDistrChain,b.statusDistriChainSpecific
