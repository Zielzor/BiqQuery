...
WHEN RunningTotal >= 0.2 THEN "TOP MOVER"
WHEN RunningTotal < 0.2 THEN "SLOW  MOVER"
END as MoversClass,
NNT,
PercentageOfTotal,
...
# Monitorowanie zmian
---------------- Porownanie bakapu i aktualnego
CREATE OR REPLACE TABLE `ceeregion-prod.NonMoversAutomation.FactMoversDynamic5810` as 
SELECT 
a.Aktualizacja as Actual,
a.MATKL,
a.MoversClass as CuurentMoverClass,
b.Aktualizacja as Previous, 
b.MoversClass as PreviousMoverClass,
CASE
WHEN a.MoversClass != b.MoversClass THEN "1"
ELSE "0"
END as Change
...
FROM `ceeregion-prod.NonMoversAutomation.step5_final` as a 
LEFT JOIN  `ceeregion-prod.NonMoversAutomation.20201208` as b on a.MATKL = b.MATKL #tą date trzeba zmieniac na tabele archowalną